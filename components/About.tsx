...
const About = (props: Props) => {
  return (
    <div className="h-[20rem] bg-fixed bg-center bg-[url('/bg.jpg')] p-4 flex flex-col items-center justify-center space-y-10 text-[#5eff00]">
      <h1 className="uppercase text-4xl font-bold font-Stretch">
        My little story
      </h1>
      <p className="text-xl font-Louis font-bold w-[50%] text-justify p-4 bg-gray-500/70">
      ...
      <button className="font-Barcelona text-4xl font-bold">Download CV</button>
    </div>
  );
}
