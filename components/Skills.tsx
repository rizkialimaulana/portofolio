      ...
      <div className="flex w-full h-full mt-5">
        <div className="flex-1 md:flex-[0.5] p-4">
          <div className="flex flex-col justify-center">
            <h1 className="text-4xl font-Conthrax uppercase">Skills</h1>
            ...
            <div className="flex flex-col space-y-5 mt-2 ">
              <div className="flex flex-row space-x-12">
                ...
                <div className="flex flex-col space-y-3 p-2 font-Barcelona">
                  <span className='text-blue-400 font-bold text-lg'>Full-Stack</span>
              ...
              <div className="flex flex-row space-x-12">
                ...
                <div className="flex flex-col space-y-3 p-2 font-Barcelona">
                  <span className='text-blue-400 font-bold text-lg'>Frontend Development</span>
                  <ul className="list-disc">
              ...
              <div className="flex flex-row space-x-12">
                ...
                <div className="flex flex-col space-y-3 p-2 font-Barcelona">
                  <span className='text-blue-400 font-bold text-lg'>Backend Development</span>
                  <ul className="list-disc">
              ...
              <div className="flex flex-row space-x-12">
                ...
                <div className="flex flex-col space-y-3 p-2 font-Barcelona">
                  <span className='text-blue-400 font-bold text-lg'>Fundamentals</span>
                  <ul className="list-disc">
